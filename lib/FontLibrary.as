...
@mxmlc -o bin/FontLibrary.swf -static-link-runtime-shared-libraries=true -noplay
*/
package  
{
	...
	public class FontLibrary extends Sprite 
	{
		...
		*/
		...
		public static const latoFontClass:Class;
		
		[Embed(source='icon_font.ttf'
		...
		public static const iconFontClass:Class;
		
		public function FontLibrary() 
		{
			Font.registerFont(latoFontClass);
			Font.registerFont(iconFontClass);
